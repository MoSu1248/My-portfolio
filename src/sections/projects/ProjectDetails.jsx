...
import WindowHeader from "../about/WindowHeader";
import backArrow from "../../assets/shared/arrow_right_icon.svg";
    ...
    >
      ...
      >
        <motion.div className="img-container">
          <motion.img
            initial={{ opacity: 0, boxShadow: 0, scale: 0.8 }}
            whileInView={{
              opacity: 1,
              boxShadow: "1px 2px 6px 5px rgba(0, 0, 0, 0.27)",
              scale: 1,
            }}
        ...
        {/* <div className="project__description">
            ...
            <div className="project__description-links"></div>
            <div className="project__description-technology"></div>
          </div> */}
      </motion.div>
    </motion.div>
  );
