...
import "./ProjectArchiveDetails.scss";
import ProjectArchiveGrid_Skeleton from "./ProjectArchiveGrid_Skeleton";

export default function ProjectArchiveDetails({
  lesserProjects,
  lesserProjectsClose,
}) {
      ...
      {lesserProjects && (
        ...
        >
          ...
          >
            ...
            {loading ? <ProjectArchiveGrid_Skeleton /> : <ProjectArchiveGrid />}
            <div className="projectArchive-footer">
              <a
                href="https://github.com/MoSu1248/LeetCode"
                target="_blank"
                rel="noreferrer noopener"
                className={`archiveBtn-styling`}
              >
                View GitHub
                <svg
                  width="20"
